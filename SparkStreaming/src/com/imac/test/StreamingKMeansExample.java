...
public class StreamingKMeansExample  {
	...
	public static void main(String[] args) {
		  if (args.length != 5) {
		    ...
		    JavaDStream<Vector> trainingData =ssc.textFileStream(args[1]).map(new Function<String, Vector>() {
		    ...
		    JavaDStream<LabeledPoint> testData = ssc.socketTextStream("localhost", 9999).map(new Function<String, LabeledPoint>() {
